...
def map_songs_to_notes():
    ...
    dark_song_indices = np.random.choice(38, 31, replace=False)
    print(len(light_dark_song_dict["dark"]))
    light_val_indices = np.setdiff1d(np.arange(53), light_song_indices).tolist()
    dark_val_indices = np.setdiff1d(np.arange(38), dark_song_indices).tolist()
